public class Pachy.Services.Network.Network : Object {
    ...
    public delegate void NodeCallback (Json.Node node, Soup.Message msg);
    ...
    construct {
        session = new Soup.Session () {
            user_agent = "%s/%s libsoup/%u.%u.%u %d.%d.%d".printf (
                Build.NAME,
                Build.VERSION,
